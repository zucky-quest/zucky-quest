...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=apple,aws,bitbucket,css,discord,django,figma,firebase,flutter,gcp,go,html,instagram,java,js,jenkins,kubernetes,laravel,linkedin,linux,md,mysql,notion,npm,obsidian,php,postgres,postman,prisma,py,rails,react,redis,regex,ruby,sass,sqlite,svg,tailwind,terraform,ts,ubuntu,vercel,vite,vscode,windows,yarn" />
  </a>
</p>
